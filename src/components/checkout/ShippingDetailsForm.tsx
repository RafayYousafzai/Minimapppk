      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value ?? "PK"}>
              <FormControl>
                <SelectTrigger>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <Select onValueChange={field.onChange} defaultValue={field.value ?? "Punjab"}>
              <FormControl>
                <SelectTrigger>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="54000" {...field} value={field.value ?? ""} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
